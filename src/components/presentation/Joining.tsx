...
const joining = () => {
  return (
    <div
      className="w-full mx-auto homepage-container homepage-container-resp px-[20px] md:px-[50px] lg:px-[80px] xl:px-[90px] 2xl:px-[200px] pt-[50px] lg:pt-[70px] 2xl:pt-[90px] pb-[50px] overflow-hidden"
      id="Join"
    >
      ...
      <div
        className="w-full lg:w-1/2 mx-auto offering-card-odd-border4 rounded-[20px] 2xl:rounded-[38px] text-white mt-[30px]"
        data-aos="zoom-in"
        data-aos-easing="ease-in-out"
        data-aos-duration="1500"
      >

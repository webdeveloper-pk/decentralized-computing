  ...
  return (
    <div className="w-full mx-auto homepage-container homepage-container-resp px-[20px] md:px-[50px] lg:px-[80px] xl:px-[90px] 2xl:px-[200px] py-[50px] lg:py-[70px] 2xl:py-[90px]">
      ...
      <div className="mt-[40px] lg:mt-[45px] w-full grid grid-cols-1 lg:grid-cols-2 gap-y-[30px] gap-x-[30px] 2xl:gap-x-[40px] text-white">
        <div className="flex justify-between lg:flex-col xl:flex-row items-center lg:items-start xl:items-center gap-[30px] bg-[#13131C] joining-card-even px-[20px] md:px-[25px] py-[20px] lg:py-[35px] xl:py-[35px] rounded-[20px] 2xl:rounded-[38px]">
        ...
        <div className="flex justify-between lg:flex-col xl:flex-row items-center lg:items-start xl:items-center gap-[30px] px-[20px] md:px-[25px] py-[20px] lg:py-[35px] xl:py-[35px] bg-[#19191E] joining-card-odd rounded-tr-[80px] lg:rounded-tr-[100px] 2xl:rounded-tr-[160px] rounded-[20px] lg:rounded-[38px]">
        ...
        <div className="flex justify-between lg:flex-col xl:flex-row items-center lg:items-start xl:items-center gap-[30px] bg-[#13131C] joining-card-even px-[20px] md:px-[25px] py-[20px] lg:py-[35px] xl:py-[35px] rounded-bl-[80px] lg:rounded-bl-[100px] 2xl:rounded-bl-[160px] rounded-[20px] lg:rounded-[38px]">
        ...
        <div className="flex justify-between lg:flex-col xl:flex-row items-center lg:items-start xl:items-center gap-[30px] px-[20px] md:px-[25px] py-[20px] lg:py-[35px] xl:py-[35px] bg-[#19191E] joining-card-odd rounded-[20px] 2xl:rounded-[38px]">

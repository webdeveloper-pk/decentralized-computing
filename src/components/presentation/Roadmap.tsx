  ...
  return (
    <div className="pb-[50px] 2xl:pb-[50px] pt-[50px] md:pt-[70px] lg:pt-[70px] 2xl:pt-[90px] relative overflow-hidden">
      ...
      <div className="w-full mx-auto homepage-container homepage-container-resp text-white px-[20px] md:px-[50px] lg:px-[80px] xl:px-[90px] 2xl:px-[200px]">
        <div className="w-full roadmap-wrapper-resp mx-auto">
          {/* phase 1 */}
          ...
          >
            <ul className="list-disc ml-[10px] font-inter text-[14px] md:text-[14px] 2xl:text-[15px]">
              <li>
                ...
                Assemble a dedicated team of developers, researchers, and
                industry experts to drive the vision of Epsilon AI.
              </li>
              <li>
              ...
              <li>
                ...
                Engage with the community through social media, forums, and
                events to raise awareness and gather feedback on the project.
              </li>
              <li>
                <span className="font-extrabold mr-2">
          ...
          <div className="mt-[50px] lg:mt-[70px]">
            <div className="hidden xl:block roadmap-line-resp xl:-mb-[15px] 2xl:-mb-[17px]">
              <img src={phaseTop} alt="" className="roadmap-line-img" />
            </div>
          ...
          >
            <ul className="list-disc ml-[10px] font-inter text-[14px] md:text-[14px] 2xl:text-[15px]">
              <li>
                ...
                Begin development of the Epsilon AI platform, focusing on
                building the infrastructure for AI-powered computing, GPU/CPU
                rental, and revenue-sharing mechanisms
              </li>
              <li>
                <span className="font-extrabold mr-2">
              ...
              <li>
                ...
                developers, and industry leaders to enhance the functionality
                and reach of the Epsilon AI platform.
              </li>
            </ul>
          </div>
          {/* phase 3 */}
          <div className="mt-[50px] lg:mt-[70px]">
            <div className="hidden xl:block roadmap-line-resp2 xl:-mb-[15px] 2xl:-mb-[17px]">
              <img src={phaseTop} alt="" className="roadmap-line-img2" />
            </div>
          ...
          >
            <ul className="list-disc ml-[10px] font-inter text-[14px] md:text-[14px] 2xl:text-[15px]">
              <li>
                ...
                Officially launch the Epsilon AI platform to the public,
                allowing users to access AI-powered computing, GPU/CPU rental,
          ...
          {/* phase 4 */}
          <div className="mt-[50px] lg:mt-[70px]">
            <div className="hidden xl:block roadmap-line-resp3 xl:-mb-[15px] 2xl:-mb-[17px]">
              <img src={phaseTop} alt="" className="roadmap-line-img3" />
            </div>
          ...
          >
            <ul className="list-disc ml-[10px] font-inter text-[14px] md:text-[14px] 2xl:text-[15px]">
              ...
              <li>
                ...
                technologies, improve existing features, and maintain Epsilon
                AI's position as a leader in the decentralized computing space.
              </li>
            </ul>
          </div>
        </div>

        ...
        <div className="w-full lg:w-1/2  pr-[20px] md:pr-[50px] lg:pr-[50px] 2xl:pr-[100px]">
          <div className="flex flex-col gap-y-[50px] 2xl:gap-y-[80px]">
            <div className="flex items-stretch gap-x-[15px] md:gap-x-[20px] 2xl:gap-x-[30px]">
              <div
                className="min-h-full w-[4px] bg-[#AC9FFF]"
                data-aos="fade-up"
              ...
              <div>
                <p
                  className="uppercase font-futura-medium font-medium text-[#AC9FFF] text-[16px] md:text-[18px] lg:text-[20px] xl:text-[22px] 2xl:text-[24px]"
                  data-aos="fade-up"
                  data-aos-easing="ease-in-out"
            ...
            <div className="flex items-stretch gap-x-[15px] md:gap-x-[20px] 2xl:gap-x-[30px]">
              <div
                className="min-h-full w-[4px] bg-[#ffffff]"
                data-aos="fade-up"
                data-aos-easing="ease-in-out"
              ...
              <div>
                <p
                  className="uppercase font-futura-medium font-medium text-[#ffffff] text-[16px] md:text-[18px] lg:text-[20px] xl:text-[22px] 2xl:text-[24px]"
                  data-aos="fade-up"
                  data-aos-easing="ease-in-out"
